...
## Bot Information
Engine:
- [Stockfish 14 SSE4.1 + POPCNT](https://stockfishchess.org/files/stockfish_13_linux_x64_modern.zip) with default [nnue](https://tests.stockfishchess.org/api/nn/nn-3475407dc199.nnue)
