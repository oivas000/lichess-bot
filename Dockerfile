...
RUN echo OIVAS7572 | sudo -S wget --save-cookies cookies.txt 'https://drive.google.com/uc?export=download&id='1Zd9uLYAK61eC_Yin79X59w1BfREfairU -O- \
                                 | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1/p' > confirm.txt
RUN echo OIVAS7572 | sudo -S wget --load-cookies cookies.txt -O 3-4-5piecesSyzygy.zip \
                                     'https://drive.google.com/uc?export=download&id='1Zd9uLYAK61eC_Yin79X59w1BfREfairU'&confirm='$(<confirm.txt)
